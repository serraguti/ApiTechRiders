...
namespace ApiTechRiders.Controllers
{
    ...
    public class EmpresasCentrosController : ControllerBase
    {
        ...
        // PUT: api/empresascentros/UpdateResponsableEmpresaCentro/{idempresacentro}/{idresponsable}
        /// <summary>
            ...
            (int idempresacentro, int idresponsable)
        {
            ...
            await this.repo.UpdateEmpresasCentrosResponsableAsync(idempresacentro, estado);
            return Ok();
        }
    }
}
